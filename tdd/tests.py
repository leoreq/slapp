...
class ListViewTest(TestCase):
    ...
    def test_uses_a_list_template(self):
        ...
        response=self.client.get('/tdd/lists/%d/'%(list_.id))
    ...
    def test_displays_all_list_items(self):
        ...
        response = self.client.get('/tdd/lists/%d/'%(correct_list.id))
...
class NewListTest(TestCase):
    ...
    def test_redirect_after_a_POST_request(self):
        ...
        self.assertRedirects(response,'/tdd/lists/%d/'%(new_list.id))
...
class NewItemTest(TestCase):
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        response=self.client.post('/tdd/lists/%d/add_item'%(correct_list.id), 
    ...
    def test_redirect_to_list_view(self):
        ...
        self.assertRedirects(response,'/tdd/lists/%d/'%(correct_list.id))
